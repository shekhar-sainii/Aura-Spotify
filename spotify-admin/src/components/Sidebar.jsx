...
const Sidebar = () => {
  return (
    <div className='bg-[#003a10] min-h-screen pl-[4vw]'>
        <img className='w-[max(10vw,100px)] hidden sm:block mt-5' src={assets.logo} alt="" />
        <img className='w-[max(5vw,40px)] mr-5 block sm:hidden mt-5' src={assets.logo_small} alt="" />
